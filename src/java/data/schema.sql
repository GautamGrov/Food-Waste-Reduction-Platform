...
-- Adjusting the Status ENUM in the FoodItems table
CREATE TABLE FoodItems (
    ...
    Status ENUM('available', 'discounted', 'donated') NOT NULL DEFAULT 'available',
    Price DECIMAL(10,2) NOT NULL,
    IsSurplus BOOLEAN NOT NULL DEFAULT FALSE,
    SurplusType ENUM('donation', 'sale') DEFAULT NULL,
